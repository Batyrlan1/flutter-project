...
import 'Meethelp.dart';

class FollowClimb extends StatefulWidget {
  @override
  _FollowClimbState createState() => _FollowClimbState();
}

class _FollowClimbState extends State<FollowClimb> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              FlatButton(
                onPressed: () {},
                child: Text('Редактировать climb',
                    style: GoogleFonts.roboto(
                      color: Colors.black,
                      fontSize: 14,
                    )),
